...
<%
   ...
   int quantity = pdao.getQuantityOfProduct(productid);
   ...
   if(odao.getStatus(oid)==false){
   	...
   	{	Product p2 = new Product();
   		...
   		int productId = p.getProductid(); // Assuming getProductid() returns the product ID
   		int newQuantity = upquantity;
   		pdao.updateQuantityAfterCancellation(productId,newQuantity);
