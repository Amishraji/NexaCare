...
<html lang="en">
   ...
   <body class="img js-fullheight" style="background-image: url(Homepage/assets/img/pharmaimg.jpg);">
      ...
      <div class="container">
         <c:if test="${param.msg == 'userRegFail'}">
         ...
         <div class="row">
            ...
            <div class="col-md-8">
               <form action="registerUser" method="post" id="fileForm" role="form">
                  <fieldset>
                     <h2 align="center">User Registrations<span class="req"></span></h2>
                     <div class="form-group">
                        <label for="userid"><span class="req">* </span> User name:  <small>This will be your login user name</small> </label> 
                        <input class="form-control" type="text" name="userid" id = "userid" onchange="user_validate(this.value)" placeholder="minimum 6 letters" required />  
                        <div id="errLast"></div>
                        ...
                        <input required type="text" name="age" id="age" class="form-control phone" max="60" min="18" onkeyup="validatephone(this);" placeholder="Enter Your Age"/> 
